...
class MetricsHttpEventHandlerTest {
  ...
  void setup() {
    ...
    listener = new MetricsHttpEventHandler(null, meterRegistry, Set.of("/test"));
  }

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void testRequests(final boolean pathFromFilter) {
    ...
    if (pathFromFilter) {
      ...
      when(request.setAttribute(eq(MetricsHttpEventHandler.REQUEST_INFO_PROPERTY_NAME), any()))
    ...
    @SuppressWarnings("unchecked") final ArgumentCaptor<Iterable<Tag>> tagCaptor =
